...
public:
    ...
    bool invertedAppearance() {
        return progress_bar->invertedAppearance();
    }
    void setInvertedAppearance(bool invertedAppearance) {
        progress_bar->setInvertedAppearance(invertedAppearance);
    }
    int maximum() const {
        return progress_bar->maximum();
    }
    int minimum() const {
        return progress_bar->minimum();
    }
    Qt::Orientation orientation() const {
        return progress_bar->orientation();
    }
    QString text() const {
        return progress_bar->text();
    }
    QProgressBar::Direction textDirection() {
        return progress_bar->textDirection();
    }
    void setTextDirection(QProgressBar::Direction textDirection) {
        progress_bar->setTextDirection(textDirection);
    }
    bool isTextVisible() const {
        return progress_bar->isTextVisible();
    }
    void setTextVisible(bool textVisible) {
        value_label->setVisible(textVisible);
    }
    int value() const {
...
/*protected slots:
    void setLabelValue(int) {
        value_label->setText(progress_bar->text() + " ");
    }*/
};
